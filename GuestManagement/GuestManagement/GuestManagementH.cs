...
namespace GuestManagement
{
    ...
    {
        SqlConnection SQLCon = new SqlConnection(@"Data Source=XINOMNOM;Initial Catalog=HotelDatabase;Integrated Security=True;Pooling=False");
        public GuestList()
        {
            InitializeComponent();
        }
        ...
        {              
            this.guestTableAdapter2.Fill(this.sWENDatabaseDataSet1.Guest);
        }
        ...
        {
            System.Data.SqlClient.SqlConnection SQLCon = new System.Data.SqlClient.SqlConnection("Data Source=XINOMNOM;Initial Catalog=HotelDatabase;Integrated Security=True;Pooling=False");
            ...
            {
                string query = "SELECT * FROM Guest where Room_ID =";
            ...
            if (Validation())
            {
                ...
                if (MessageBox.Show("Are you sure you want to update this record", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    string query = "UPDATE Guest SET Guest_FirstName = '" + vFirstName.Text + "',Guest_LastName='" + vLastName.Text + "',Guest_Age='" + iAge.Text +
                        ...
                        iPostalCode.Text  + "',Guest_Email='" + vEmail.Text + "',Room_ID='" 
